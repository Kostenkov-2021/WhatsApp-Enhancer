...
addon_info = AddonInfo(
	...
	addon_name="whatsAppEnhancer",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("WhatsApp Desktop Enhancer"),
	# Add-on description
	...
	addon_changelog=_("""added virtual menu for call menu and settings dialog
                   remove some old scripts
                   change button detections methode."""),
	# Author(s)
	addon_author="mrido1",
...
pythonSources: list[str] = ["addon/globalPlugins/*.py", "addon/appModules/*.py"]
